...
<head>
    <meta charset="UTF-8">
    <title>Giới Thiệu - Trường Học ND</title>
...
include '../background/header.php';
    ...
    <section class="content">
        <h2>Về Trường Học ABC</h2>
        <p>Trường Học ABC là một trong những ngôi trường hàng đầu với chương trình giảng dạy hiện đại.</p>
    </section>
